...
import { AUTH_TOKEN_STORAGE_KEY, USER_ROLE_STORAGE_KEY, USER_ROLE_DEFAULT } from './constants';
    ...
    !expired &&
      operation.setContext({
        headers: {
          ...
          'x-hasura-role': window.localStorage.getItem(USER_ROLE_STORAGE_KEY) || USER_ROLE_DEFAULT
        }
      });
  }
});
